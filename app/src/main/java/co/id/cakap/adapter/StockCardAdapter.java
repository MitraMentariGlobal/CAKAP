...
public class StockCardAdapter extends RecyclerView.Adapter<StockCardAdapter.ViewHolder> {
    private List<StockCardData> mResultData;
    private Context mContext;
    private LayoutInflater mLayoutInflater;

    public StockCardAdapter(List<StockCardData> resultData, Context context){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        StockCardData stockCardData = mResultData.get(position);
